...
<head>
    ...
    <!-- App css -->
    <link href="{{ asset('backend/css/bootstrap-material.min.css') }}" rel="stylesheet" type="text/css"
        id="bs-default-stylesheet" />
    <link href="{{ asset('backend/css/app-material.min.css') }}" rel="stylesheet" type="text/css"
...
<body data-sidebar-icon="twotones" data-layout='{"topbar": {"color": "light"}}'>
