<div>
    <div class="container-fluid py-3 my-4" >
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center text-orange">RAJAWALI MUTU MANUNGGAL INDONESIA - RMICERTIFICATION</h2>
                <p class="text-center">Di era globalisasi saat ini, perusahaan dituntut untuk beroperasi lebih efektif dan efisien untuk menghasilkan produk bermutu tinggi secara konsisten. Perusahaan yang mampu memenuhi tuntutan-tuntutan ini akan dapat bertahan hidup dan memenangkan persaingan global. Salah satu cara untuk menjadi perusahaan yang kompetitif adalah dengan mengikuti sistem manajemen mutu yang disarankan dalam standar ISO 9001.
...
@push('banner')
    <section class="bg-home bg-warning" id="home">
